...
class TestUserRepositoryGetById:
    ...
    async def test_get_by_id_success(self):
        ...
        mock_tx.fetch_one.assert_called_once_with("users.get_by_id", {"id": str(user_id.value)})
...
class TestUserRepositoryGetByEmail:
    ...
    async def test_get_by_email_success(self):
        ...
        mock_tx.fetch_one.assert_called_once_with("users.get_by_email", {"email": "jane@example.com"})
