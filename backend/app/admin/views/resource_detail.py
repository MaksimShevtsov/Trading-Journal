...
def build_detail_routes(router: APIRouter, site: AdminSite) -> None:
    ...
    @router.get("/{resource_name}/{record_id}", response_class=HTMLResponse, response_model=None)
    async def resource_detail(request: Request, resource_name: str, record_id: str) -> Response:
