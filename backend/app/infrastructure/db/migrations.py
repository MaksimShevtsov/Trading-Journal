...
_INSERT_APPLIED: dict[str, str] = {
    "named": ("INSERT INTO schema_migrations (version, description) VALUES (:version, :description)"),
    "pyformat": ("INSERT INTO schema_migrations (version, description) VALUES (%(version)s, %(description)s)"),
}
