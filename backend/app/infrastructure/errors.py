...
class DatabaseError(InfrastructureError):
    ...
    def __init__(self, *, message: str = "Database operation failed", cause: Exception | None = None) -> None:
        self.message = message
        self.cause = cause
...
class DataMappingError(InfrastructureError):
    ...
    def __init__(self, *, message: str = "Data mapping failed", cause: Exception | None = None) -> None:
        self.message = message
        self.cause = cause
        super().__init__(message=message)
